  ...
  return (
    <main className="mx-auto flex w-full max-w-5xl flex-col gap-6">
      <PageHeader
        ...
        title="Your profile"
        description="Keep your account details current so tenants always reach the right person."
      />
        ...
        <Card className="bg-primary text-primary-foreground">
          <CardHeader>
            ...
            <CardDescription className="text-primary-foreground/75">
              Your account is ready to manage listings.
            </CardDescription>
          </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            This information identifies you as the owner of your listings.
          </CardDescription>
        </CardHeader>
